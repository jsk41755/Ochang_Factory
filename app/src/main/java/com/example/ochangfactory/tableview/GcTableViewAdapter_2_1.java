...
public class GcTableViewAdapter_2_1 extends AbstractTableAdapter<ColumnHeader, RowHeader, Cell> {
    ...
    @NonNull
    private final GcTableViewModel_2_1 mGcTableViewModel_2_1;

    public GcTableViewAdapter_2_1(@NonNull GcTableViewModel_2_1 GctableViewModel_2_1) {
        super();
        this.mGcTableViewModel_2_1 = GctableViewModel_2_1;
    }
    ...
    public View onCreateCornerView(@NonNull ViewGroup parent) {
        ...
        corner.setOnClickListener(view -> {
            SortState sortState = GcTableViewAdapter_2_1.this.getTableView()
                    .getRowHeaderSortingStatus();
            if (sortState != SortState.ASCENDING) {
                Log.d("TableViewAdapter", "Order Ascending");
                GcTableViewAdapter_2_1.this.getTableView().sortRowHeader(SortState.ASCENDING);
            } else {
                Log.d("TableViewAdapter", "Order Descending");
                GcTableViewAdapter_2_1.this.getTableView().sortRowHeader(SortState.DESCENDING);
            }
        });
        return corner;
    }
