...
public class GcTableViewAdapter_1_2 extends AbstractTableAdapter<ColumnHeader, RowHeader, Cell> {
    ...
    private static final String LOG_TAG = GcTableViewAdapter_1_2.class.getSimpleName();

    @NonNull
    private final GcTableViewModel_1_2 mGcTableViewModel_1_2;

    public GcTableViewAdapter_1_2(@NonNull GcTableViewModel_1_2 GctableViewModel_1_2) {
        super();
        this.mGcTableViewModel_1_2 = GctableViewModel_1_2;
    }
    ...
    public View onCreateCornerView(@NonNull ViewGroup parent) {
        ...
        corner.setOnClickListener(view -> {
            SortState sortState = GcTableViewAdapter_1_2.this.getTableView()
                    .getRowHeaderSortingStatus();
            if (sortState != SortState.ASCENDING) {
                Log.d("TableViewAdapter", "Order Ascending");
                GcTableViewAdapter_1_2.this.getTableView().sortRowHeader(SortState.ASCENDING);
            } else {
                Log.d("TableViewAdapter", "Order Descending");
                GcTableViewAdapter_1_2.this.getTableView().sortRowHeader(SortState.DESCENDING);
            }
        });
        return corner;
    }
    ...
    public int getCellItemViewType(int column) {
        ...
        // type of CellViewHolder on "onCreateCellViewHolder"
        switch (column) {
            case GcTableViewModel_1_2.MOOD_COLUMN_INDEX:
                return MOOD_CELL_TYPE;
            case GcTableViewModel_1_2.GENDER_COLUMN_INDEX:
