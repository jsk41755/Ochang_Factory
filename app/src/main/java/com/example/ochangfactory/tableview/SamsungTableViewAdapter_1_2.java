...
public class SamsungTableViewAdapter_1_2 extends AbstractTableAdapter<ColumnHeader, RowHeader, Cell> {
    ...
    private static final String LOG_TAG = SamsungTableViewAdapter_1_2.class.getSimpleName();

    @NonNull
    private final SamsungTableViewModel_1_2 mSamsungTableViewModel_1_2;

    public SamsungTableViewAdapter_1_2(@NonNull SamsungTableViewModel_1_2 SamsungTableViewModel_1_2) {
        super();
        this.mSamsungTableViewModel_1_2 = SamsungTableViewModel_1_2;
    }
    ...
    public View onCreateCornerView(@NonNull ViewGroup parent) {
        ...
        corner.setOnClickListener(view -> {
            SortState sortState = SamsungTableViewAdapter_1_2.this.getTableView()
                    .getRowHeaderSortingStatus();
            if (sortState != SortState.ASCENDING) {
                Log.d("TableViewAdapter", "Order Ascending");
                SamsungTableViewAdapter_1_2.this.getTableView().sortRowHeader(SortState.ASCENDING);
            } else {
                Log.d("TableViewAdapter", "Order Descending");
                SamsungTableViewAdapter_1_2.this.getTableView().sortRowHeader(SortState.DESCENDING);
            }
        });
        return corner;
    }
    ...
    public int getCellItemViewType(int column) {
        ...
        // type of CellViewHolder on "onCreateCellViewHolder"
        switch (column) {
            case GcTableViewModel_2_1.MOOD_COLUMN_INDEX:
                return MOOD_CELL_TYPE;
            case GcTableViewModel_2_1.GENDER_COLUMN_INDEX:
