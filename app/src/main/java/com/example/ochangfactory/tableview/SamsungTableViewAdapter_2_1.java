...
public class SamsungTableViewAdapter_2_1  extends AbstractTableAdapter<ColumnHeader, RowHeader, Cell> {
    ...
    private static final String LOG_TAG = GcTableViewAdapter_2_1.class.getSimpleName();

    @NonNull
    private final SamsungTableViewModel_2_1 mSamsungTableViewModel_2_1;

    public SamsungTableViewAdapter_2_1(@NonNull SamsungTableViewModel_2_1 SamsungTableViewModel_2_1) {
        super();
        this.mSamsungTableViewModel_2_1 = SamsungTableViewModel_2_1;
    }
    ...
    public View onCreateCornerView(@NonNull ViewGroup parent) {
        ...
        corner.setOnClickListener(view -> {
            SortState sortState = SamsungTableViewAdapter_2_1.this.getTableView()
                    .getRowHeaderSortingStatus();
            if (sortState != SortState.ASCENDING) {
                Log.d("TableViewAdapter", "Order Ascending");
                SamsungTableViewAdapter_2_1.this.getTableView().sortRowHeader(SortState.ASCENDING);
            } else {
                Log.d("TableViewAdapter", "Order Descending");
                SamsungTableViewAdapter_2_1.this.getTableView().sortRowHeader(SortState.DESCENDING);
            }
        });
        return corner;
    }
