...
public class SamsungTableViewAdapter_3_1 extends AbstractTableAdapter<ColumnHeader, RowHeader, Cell> {
    ...
    private static final String LOG_TAG = SamsungTableViewAdapter_3_1.class.getSimpleName();

    @NonNull
    private final SamsungTableViewModel_3_1 mSamsungTableViewModel_3_1;

    public SamsungTableViewAdapter_3_1(@NonNull SamsungTableViewModel_3_1 samsungTableViewModel_3_1) {
        super();
        this.mSamsungTableViewModel_3_1 = samsungTableViewModel_3_1;
    }
    ...
    public View onCreateCornerView(@NonNull ViewGroup parent) {
        ...
        corner.setOnClickListener(view -> {
            SortState sortState = SamsungTableViewAdapter_3_1.this.getTableView()
                    .getRowHeaderSortingStatus();
            if (sortState != SortState.ASCENDING) {
                Log.d("TableViewAdapter", "Order Ascending");
                SamsungTableViewAdapter_3_1.this.getTableView().sortRowHeader(SortState.ASCENDING);
            } else {
                Log.d("TableViewAdapter", "Order Descending");
                SamsungTableViewAdapter_3_1.this.getTableView().sortRowHeader(SortState.DESCENDING);
            }
        });
        return corner;
    }
    ...
    public int getCellItemViewType(int column) {
        ...
        // type of CellViewHolder on "onCreateCellViewHolder"
        switch (column) {
            case GcTableViewModel_3_1.MOOD_COLUMN_INDEX:
                return MOOD_CELL_TYPE;
            case GcTableViewModel_3_1.GENDER_COLUMN_INDEX:
