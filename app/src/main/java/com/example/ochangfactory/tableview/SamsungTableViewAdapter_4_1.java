...
public class SamsungTableViewAdapter_4_1 extends AbstractTableAdapter<ColumnHeader, RowHeader, Cell> {
    ...
    @NonNull
    private final SamsungTableViewModel_4_1 mSamsungTableViewModel_4_1;

    public SamsungTableViewAdapter_4_1(@NonNull SamsungTableViewModel_4_1 samsungTableViewModel_4_1) {
        super();
        this.mSamsungTableViewModel_4_1 = samsungTableViewModel_4_1;
    }
    ...
    public View onCreateCornerView(@NonNull ViewGroup parent) {
        ...
        corner.setOnClickListener(view -> {
            SortState sortState = SamsungTableViewAdapter_4_1.this.getTableView()
                    .getRowHeaderSortingStatus();
            if (sortState != SortState.ASCENDING) {
                Log.d("TableViewAdapter", "Order Ascending");
                SamsungTableViewAdapter_4_1.this.getTableView().sortRowHeader(SortState.ASCENDING);
            } else {
                Log.d("TableViewAdapter", "Order Descending");
                SamsungTableViewAdapter_4_1.this.getTableView().sortRowHeader(SortState.DESCENDING);
            }
        });
        return corner;
    }
